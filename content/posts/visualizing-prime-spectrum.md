...
Take a moment to understand where the name _prime_ comes from. For example, the prime ideals of $\mathbb{Z}$ are precisely the ideals generated by the primes.
